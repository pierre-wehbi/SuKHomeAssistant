...
let { APS_CLIENT_ID, APS_CLIENT_SECRET, APS_CALLBACK_URL, SERVER_SESSION_SECRET, PORT, HA_WS_URL, WS_ACCESS_TOKEN, APS_HUB_ID, APS_PROJECT_ID, APS_ITEM_ID } = process.env;
